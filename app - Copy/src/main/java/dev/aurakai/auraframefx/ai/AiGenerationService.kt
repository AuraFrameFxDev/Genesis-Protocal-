...
class AiGenerationService(
    ...
    /**
     * Asynchronously generates AI-driven text based on the given prompt and optional parameters.
     *
     * @param prompt The input prompt for text generation.
     * @param maxTokens The maximum number of tokens to generate. Defaults to 500.
     * @param temperature The randomness of the output; higher values yield more diverse results. Defaults to 0.7.
