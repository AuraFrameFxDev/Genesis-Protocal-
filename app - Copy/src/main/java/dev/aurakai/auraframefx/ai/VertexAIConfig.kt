...
data class VertexAIConfig(
     ...
     *
     * Checks that required string fields are not blank and that numeric parameters are within valid ranges. Returns an empty list if all validations pass.
     *
     * @return A list of error messages for invalid or missing fields, or an empty list if the configuration is valid.
     */
    ...
    /**
     * Returns the base URL for Vertex AI API requests, combining the configured endpoint, API version, project ID, and location.
     *
    ...
    /**
     * Returns the complete URL for the Vertex AI content generation endpoint for the configured model.
     *
     * The URL includes the base endpoint, API version, project ID, location, and model name, targeting the `generateContent` method.
     *
     ...
     *
     * The development configuration disables safety filters and caching, reduces retries and timeout for quicker iteration, and enables metrics and verbose logging.
     *
