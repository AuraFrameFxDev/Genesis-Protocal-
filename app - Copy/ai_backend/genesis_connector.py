...
class GenesisBridgeServer:
    ...
    def start(self):
        ...
        Signals readiness to the Android client, launches a background thread for request handling, and continuously reads and enqueues incoming JSON requests. Sends error responses for invalid JSON input and supports graceful shutdown on keyboard interruption.
        """
        self.running = True
    ...
    def _handle_ping(self):
        ...
        Returns:
            dict: Contains system status, confirmation message, and the current timestamp.
        """
        return {
            "success": True,
            "persona": "genesis",
