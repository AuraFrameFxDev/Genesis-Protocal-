...
def create_mock_response(status_code=200, json_data=None, headers=None, text=None):
    """
    Generate a mock HTTP response object for testing with configurable status code, headers, text, and JSON data.
    ...
    Parameters:
        ...
        text (str, optional): The response text content.
...
def create_test_connector(config_overrides=None):
    """
    Instantiate a GenesisConnector using default test configuration, with optional overrides.
